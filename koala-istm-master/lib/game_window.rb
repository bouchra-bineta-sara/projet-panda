...
attr_reader :score
  def initialize
    ...
    @ui = UI.new
    @background_sprite = Gosu::Image.new(self, 'images/rose.png', true)
    @koala_sprite = Gosu::Image.new(self, 'images/koala.png', true)
    @enemy_sprite = Gosu::Image.new(self, 'images/trou.png', true)
    @flag_sprite = Gosu::Image.new(self, 'images/rouge.png', true)
    ...
    @music = Gosu::Song.new(self, "musics/baby.wav")
